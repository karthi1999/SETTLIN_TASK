                  ...
                  {expenseData &&
                          ...
                          {expensesForDate.map((expense) => {
                            ...
                            return (
                              <div key={expense.uuid} className='p-2 px-5 w-full flex justify-between items-center'>
                                ...
                                <p className='font-semibold flex gap-2 items-center'>&#x20B9; {spend}
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="red" className="w-6 h-6" onClick={() => { deleteHandle(expense.uuid) }}>
                    ...
                    : (
                      <div className='w-full h-full flex justify-center items-center'>
                        <img src="/no-data.jpg" alt="no data" className='h-56 w-auto' />
                      </div>
                    )
                  }
